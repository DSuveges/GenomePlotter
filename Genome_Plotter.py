...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', '--dummy', action='store_true', type = bool, help = 'For testing purposes a dummy is saved with matching dimensions.', default = False)

    # Testing input parameters and report:
